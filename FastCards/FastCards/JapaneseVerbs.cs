		...
		public static Deck Load()
		{
			Deck deck = new Deck
			{
				...
				cards = new List<Card>
				{
					...
					new Card("いる", "iru", new List<string>{"to exist", "to need", "to be", "to stay"}),
					new Card("入れる", "ireru", new List<string>{"to insert", "to put in"}),
					new Card("歌う", "utau", "to sing"),
					new Card("生まれる", "umareru", "to be born"),
					new Card("売る", "uru", "to sell"),
					new Card("起きる	", "okiru", new List<string>{"to get up", "to stand up"}),
					new Card("おく", "oku", "to put"),
					new Card("送る", "okuru", "to send"),
					new Card("押す", "osu", "to push"),
					new Card("覚える", "oboeru", new List<string>{"to memorize", "to memorise", "to remember"}),
					...
					new Card("消える", "kieru", new List<string>{"to go out", "to vanish" }),
					new Card("聞く", "kiku", "to listen"),
					new Card("切る", "kiru", "to cut"),
					new Card("着る", "kiru", new List<string>{"to wear", "to put on" }),
					new Card("来る", "kuru", "to come"),
					new Card("消す", "kesu", new List<string>{"to turn off", "to switch off" }),
					...
					new Card("吸う", "suu", new List<string>{"to breath", "to smoke" }),
					new Card("住む", "sumu", new List<string>{"to live", "to reside somewhere" }),
					new Card("する", "suru", "to do"),
					new Card("座る", "suwaru", "to sit"),
					new Card("出す", "dasu", new List<string>{"to take out" , "to hand in"}),
					new Card("立つ", "tatsu", "to stand"),
					new Card("頼む", "tanomu", new List<string>{"to ask", "to request" }),
					...
					new Card("作る", "tsukuru", new List<string>{"to make", "to produce" }),
					...
					new Card("鳴く", "naku", new List<string>{"to chirp", "to make animal sounds", "to sing" }),
					...
					new Card("乗る", "noru", new List<string>{"to ride", "to take" }),
					...
					new Card("話す", "hanasu", new List<string>{"to talk", "to tell", "to speak" }),
					new Card("張る", "haru", new List<string>{"to put something on", "to stick" }),
					...
					new Card("磨く", "migaku", new List<string>{"to polish", "to brush"}),
					new Card("見せる", "miseru", "to show"),
					new Card("見る", "miru", new List<string>{"to see", "to watch" }),
					new Card("持つ", "motsu", new List<string>{"to have", "to own" }),
					new Card("休む", "yasumu", "to rest"),
					new Card("やる", "yaru", "to do"),
					new Card("呼ぶ", "yobu", "to call"),
					new Card("読む", "yomu", "to read"),
					new Card("分かる", "wakuru", new List<string>{"to understand", "to know" }), 
